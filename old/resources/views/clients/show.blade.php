                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <img src="{{ $logoUrl }}" onerror="this.src='{{ asset('images/default-company.png') }}'"
                                alt="Logo" class="w-24 h-24 rounded-full object-cover border-4 border-white shadow-md">
                        </div>
                    </div>
                       ...
                       ($client->interest_status === 'not_interested' ? 'bg-yellow-100 text-red-800' : 'bg-gray-100 text-orange-800') }}">
                        ...
                        <div class="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-100">
                            ...
                            <form class="prevent-multi-submit" method="POST" action="{{ route('client-edit-requests.store', $client) }}">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">الحقل المطلوب
                                            تعديله</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">سبب التعديل</label>
                    ...
                    <div id="edit-tab" class="tab-content hidden">
                        ...
                        <form action="{{ route('clients.update', $client->id) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">منصب المسؤول</label>
...
<!-- Last Contact Modal -->
<div id="lastContactModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">

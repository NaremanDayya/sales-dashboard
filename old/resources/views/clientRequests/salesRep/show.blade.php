...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h1 class="h3 fw-bold mb-2">Request Details</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('client-request.index') }}">Requests</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-header bg-primary bg-opacity-10 py-3">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-semibold">Request #{{ $request->id }}</h5>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mt-5">
                <a href="{{ route('client-request.index') }}" class="btn btn-outline-secondary">

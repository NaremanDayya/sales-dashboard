    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-md overflow-hidden p-6 mb-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-800">أضف إتفاقية جديدة</h2>
            ...
            <form action="{{ route('salesrep.agreements.store', $salesrep) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select id="service_id" name="service_id" onchange="handleServiceChange()" class="form-control"
                            required>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" id="signing_date" name="signing_date" value="{{ old('signing_date') }}"
                                required
                        ...
                        <div class="space-y-2">
                            <label for="implementation_date"
                                class="block text-sm font-medium text-gray-700">تاريخ التنفيذ</label>
                            <input type="date" id="implementation_date" name="implementation_date"
                                value="{{ old('implementation_date') }}" required
                                class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <!-- Duration -->
                        <div class="space-y-2">
                            <label for="duration_years" class="block text-sm font-medium text-gray-700">مدة الاتفاقية
                                (بالسنوات)</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-2" id="product_quantity_wrapper">
                            ...
                            <input type="number" id="product_quantity" name="product_quantity"
                                value="{{ old('product_quantity') }}" min="1" required
                                class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
...
<script>
    function handleServiceChange() {
        ...
        if (isFlatPrice) {
            ...
            quantityInput.removeAttriثيbute('required');
            quantityInput.value = '';
        } else {

    ...
    <div
        ...
        <nav class="nav flex-row items-center gap-1 mx-4 hidden lg:flex">
            ...
            <a href="{{ route('salesreps.credentials') }}"
                class="nav-link flex items-center gap-2 {{ request()->routeIs('salesreps.credentials') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-current" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm6-3h-1v-1a2 2 0 10-4 0v1h-1a1 1 0 00-1 1v4a1 1 0 001 1h6a1 1 0 001-1v-4a1 1 0 00-1-1z" />
                </svg>

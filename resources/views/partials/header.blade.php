...
@endphp
<header dir="rtl" class="sticky top-0 z-[1000]">
    <div
        class="header-container flex items-center justify-between h-24 px-6 py-4 bg-white dark:bg-neutral-900 shadow-sm border-b border-gray-200 dark:border-neutral-700 w-full">
        ...
        <div class="header-actions flex items-center gap-3">
            ...
            <div x-data="{ chatDropdownOpen: false }" class="relative">
                ...
                <div x-show="chatDropdownOpen" @click.away="chatDropdownOpen=false"
                    ...
                    x-transition:leave-end="opacity-0 translate-y-1" class="absolute right-0 mt-2 w-96 origin-top-right"
            ...
            @endphp
            <div x-data="{ notifDropdownOpen: false }" class="relative" x-init="$store.notifications.init()">
                <button @click="notifDropdownOpen = !notifDropdownOpen"
                    ...
                    <template x-if="$store.notifications.unreadCount > 0">
                        <span
                            class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center transform translate-x-1/2 -translate-y-1/2 animate-pulse"
                ...
                <div x-show="notifDropdownOpen" @click.away="notifDropdownOpen=false"
                    ...
                    <div
                        class="text-sm h-[500px] bg-white border overflow-hidden dark:border-neutral-700 rounded-xl shadow-xl border-neutral-200/70 text-neutral-700 dark:bg-neutral-900">

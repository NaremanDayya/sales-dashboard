...
<body>
    <!-- Clients Table -->
    <div class="table-component" id="clients-table">
        <div class="table-header">
            <h2 class="table-title">العملاء</h2>
        ...
        <div class="table-filters">
            <div class="search-box">
                <input type="text" class="search-input" placeholder="بحث..." oninput="searchClients(this.value)">
    ...
    <script>
        ...
        const clientsData = [
            ...
            {
                id: 1003,
                name: "شركة المستقبل للأجهزة",
                email: "contact@future-devices.com",
                phone: "+966503456789",
                status: "active",
                joinDate: "05/05/2023",
                agreementsCount: 3,
        ...
        function renderClientsTable(data = clientsData) {
                ...
                tbody.innerHTML = `
                    <tr>
                        <td colspan="8" class="empty-state">
                            ...
                            <div class="empty-text">لا توجد عملاء متاحين</div>
                            <button class="btn btn-primary" onclick="addNewClient()">
            ...
            data.forEach(client => {
                ...
                const row = `
                    <tr>
                        ...
                        <td>${client.agreementsCount}</td>
                        <td>
                            <div class="action-btns">
                                <button class="action-btn edit" title="تعديل" onclick="editClient(${client.id})">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="action-btn delete" title="حذف" onclick="deleteClient(${client.id})">
                                    <i class="fas fa-trash"></i>
                                </button>
                                <button class="action-btn" title="عرض" onclick="viewClient(${client.id})">
            ...
            renderPagination('clients-pagination', 1, 5);
        }

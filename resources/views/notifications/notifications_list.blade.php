 @forelse ($notifications as $notification)
        ...
        <a href="{{ route('notification.redirect', ['nid' => $notification->id, 'redirect_to' => $link]) }}"
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-shrink-0 mt-0.5">
                    <div
                        class="h-8 w-8 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center">
        ...
        <div class="p-8 text-center">
            ...
            <h4 class="mt-4 text-gray-500 dark:text-neutral-400 font-medium">لا توجد إشعارات بعد</h4>
            <p class="mt-1 text-sm text-gray-400 dark:text-neutral-500">سنقوم بإعلامك عند وصول أي جديد</p>
        </div>
        @endforelse

                            ...
                            @if($message->message === 'like')
                                <div class="flex justify-center w-full py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                                         class="w-12 h-12 text-indigo-500 transform hover:scale-110 transition-transform">
                    ...
                    <div class="w-10 flex max-w-fit items-center">
                        <button type="button" wire:click="sendLike"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 ...
                                 class="w-6 h-6 text-indigo-500 hover:text-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300">
                                <path stroke-linecap="round" stroke-linejoin="round"

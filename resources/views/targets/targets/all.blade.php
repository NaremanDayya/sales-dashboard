...
<body>
    ...
    function renderTable(data = targetsData) {
        ...
        data.forEach(target => {
            const status = target.commission_status ? target.commission_status.toLowerCase() : '';
    ...
    document.getElementById('searchInput').addEventListener('input', function(e) {
        ...
        const filteredData = targetsData.filter(target =>
            (target.service_type || '').toLowerCase().includes(searchTerm) ||
    ...
    function applyFilter() {
        ...
        const filteredData = targetsData.filter(target =>
            (target.commission_status || '').toLowerCase() === filterValue.toLowerCase()
        );
        renderTable(filteredData);
    }

...
@section('title', 'اتفاقيات الفريق - ' . $manager->name)
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="table-container">
            <div class="table-header">
                <h2 class="table-title">اتفاقيات فريق {{ $manager->name }}</h2>
            </div>
            ...
            <div class="table-responsive">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-4">لا توجد اتفاقيات</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

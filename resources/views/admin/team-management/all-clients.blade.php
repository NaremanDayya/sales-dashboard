...
@section('title', 'جميع العملاء - Admin')
    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="table-container">
            <div class="table-header">
                <h2 class="table-title">جميع العملاء في النظام</h2>
            </div>
                    ...
                    <tbody>
                        @forelse($clients as $client)
                            <tr>
                                ...
                                <td>
                                    @if($client->salesRep->manager)
                                        <span class="badge badge-blue">
                                            {{ $client->salesRep->manager->name }}
                                        </span>
                                    @else
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-4">لا توجد عملاء</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

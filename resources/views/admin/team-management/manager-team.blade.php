...
@section('title', 'فريق المدير - ' . $manager->name)
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <a href="{{ route('admin.team.index') }}" class="btn btn-outline-primary mb-3">
                <i class="fas fa-arrow-right"></i> العودة لإدارة الفرق
            </a>
            <h1 class="text-3xl font-bold text-gray-900">فريق المدير: {{ $manager->name }}</h1>
            <p class="text-gray-600 mt-2">{{ $manager->user->email }}</p>
        </div>
        ...
        <div class="table-container">
            <div class="table-header">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.team.manager.clients', $manager) }}" class="btn btn-outline-primary">
                        <i class="fas fa-users"></i> جميع العملاء
                    </a>
                    <a href="{{ route('admin.team.manager.agreements', $manager) }}" class="btn btn-outline-primary">
                    ...
                    <tbody>
                        @forelse($teamMembers as $member)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.team.member.details', $member) }}" class="btn btn-sm btn-primary">

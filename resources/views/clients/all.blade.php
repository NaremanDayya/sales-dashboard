        ...
        <div class="table-responsive">
            <div class="pdf-content">
                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            <th>شعار شركة العميل <i class="fas fa-building"></i></th>
                            <th>اسم الشركة <i class="fas fa-store"></i></th>
                            <th>مقر الشركة <i class="fas fa-map-marker-alt"></i></th>
                            <th>اسم الشخص المسؤول <i class="fas fa-user"></i></th>
                            <th>المنصب الوظيفي <i class="fas fa-briefcase"></i></th>
                            <th>رقم الجوال <i class="fas fa-phone"></i></th>
                            <th>واتس اب مباشر <i class="fab fa-whatsapp"></i></th>
                            <th>حالة الاهتمام <i class="fas fa-heart"></i></th>
                            <th>تاریخ آخر تواصل <i class="fas fa-calendar-alt"></i></th>
                            <th>عدد مرات التواصل <i class="fas fa-comments"></i></th>
                            <th>حالة وجود طلب <i class="fas fa-clipboard-check"></i></th>
                            <th>نوع الطلب <i class="fas fa-tag"></i></th>
                            <th>حالة الاستجابة <i class="fas fa-reply"></i></th>
                            <th>الدردشة <i class="fas fa-comments"></i></th>
                        </tr>
                    </thead>
                    <tbody id="tableBody">

...
<div class="table-html no-sidebar">
 ...
 <input type="text" id="filterDate" placeholder="يوم-شهر-سنة" class="form-input"
        style="padding: 8px 12px; border-radius: 6px; border: 1px solid #cbd5e1; direction: rtl; text-align: right; min-width: 150px;">
    ...
    @if($client['company_logo'])
        <div class="relative rounded-full border-2 border-gray-200 overflow-hidden w-full h-full bg-white">
            <img src="{{ $client['company_logo'] }}"
                 ...
                 loading="lazy"
                 onerror="this.style.display='none'; this.parentNode.innerHTML='<div class=\'w-full h-full flex items-center justify-center\'><i class=\'fas fa-building text-gray-400\'></i></div>'">
        </div>
    @else
        <div class="rounded-full border-2 border-gray-200 bg-gray-100 w-full h-full flex items-center justify-center">

        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            {{ $errors->has('interested_service') ? 'border-red-500' : '' }}" {{ $editableField !== 'interested_service' ? 'disabled' : '' }}>
                                                ...
                                                @foreach($services as $service)
                                                    <option
                                                        value="{{ $service->id }}" {{ old('interested_service') == $service->id ? 'selected' : '' }}>
                                                        {{ $service->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="w-32">
                                                <label for="interested_service_count"
                                                       class="block text-sm font-medium text-gray-700 mb-1">العدد المهتم
                                                    به</label>
                                                <input type="number" id="interested_service_count"

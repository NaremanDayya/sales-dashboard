...
Route::prefix('sales-reps')->group(function () {
    ...
    Route::get('{id}/preview-pdf', [pdfController::class, 'previewSalesRepPdf'])->name('salesreps.preview.pdf');
});
/*
|--------------------------------------------------------------------------
...
Route::get('admin/allPendedRequests', [SalesRepController::class, 'allPendingRequests'])->name('admin.allPendingRequests');
Route::get('salesrep/{salesRep}/MyPendedRequests', [SalesRepController::class, 'myPendingRequests'])->name('myPendingRequests');
Route::put(
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/sales-reps/{salesRep}/commissions', [SalesRepCommissionController::class, 'index'])
